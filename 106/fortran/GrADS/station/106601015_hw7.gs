...
while(tt<25)
'c'
'enable print 106601015_hw7_pm25_'tt'.gmf'
'set t 'tt
'set lon 119.3 122.2'
'set lat 21.5 25.5'
...
'd pm25'
if (tt<10)
'draw title PM2.5_20150401_0'tt'Z((10^-6g)/m^3)'
else
'draw title PM2.5_20150401_'tt'Z((10^-6g)/m^3)'
endif
'set gxout vector'
'set arrscl 1 10'
'd u;v'
...
'print'
'disable print'
'printim 106601015_hw7_pm25_'tt'.gif gif'
...
while(tt<25)
'c'
'enable print 106601015_hw7_o3_'tt'.gmf'
'set t 'tt
'set lon 119.3 122.2'
'set lat 21.5 25.5'
'set vpage 0 8.5 0 11'
...
'draw title O3_20150401_'tt'Z((10^-6)g/m^3)'
'set gxout vector'
'set arrscl 1 10'
'set ccolor 1'
'd u;v'
...
'print'
'disable print'
'printim 106601015_hw7_o3_'tt'.gif gif'
